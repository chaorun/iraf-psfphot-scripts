...
#
#        ===========================================================
#      PROCEDURE TO PERFORM DAOFIND AND PHOT TASK (OVER STANDARD FRAMES)
#        ===========================================================
# 
...
procedure casleored2 (fwhm, sky_std, aperture, datamax)
...
begin
      ...
      print ('', >> "casleored2_data")
      print ('Fitrad: ', fitrad, >> "casleored2_data")
      print ('STDDEV: ', sstd, >> "casleored2_data")
      print ('Aperture: ', apert2, >> "casleored2_data")
      print ('Datamax: ', dmax, >> "casleored2_data")
...
# ------------------------------------------------------------------------------------
      ...
      # ------------------------------------------------------------------------------
      # We store the names of the standards frames in a file ("estandars")
...
# ------------------------------------------------------------------------------------
      ...
      print (' of "cbox" must be something like twice the FWHM ('//2*fitrad//' in this case)') # Page 9 of 'A user's guide to
      print (' Otherwise a "cbox" value of 5 is fine')                                         # stellar CCD photometry...' by
      print (' Since the FWHM is '//fitrad//' it is recommended to use a "cbox" value of: ')   # Massey & Davis
      if (fitrad >= 4.) {
          cbox = 2*fitrad
          print (' cbox = '//cbox)
      }
      ...
      phot ("@estandars2", "default", "default")
...
# ------------------------------------------------------------------------------------
      ...
      print ('                                                       ')
      print (' ----------------------------------------------------- ')
      print (' Script "casleored2" finished correctly.               ')
      print (' Move on to the "casleored3" script                   ')
      print ('') 
